...
import TitleImg from '../assets/images/proman.jpg';
import SupportedBy from "../components/supported";
import Footer from "../components/footer";


export default function IzyProman(){
    return(
        <>
            <Header/>
            <TitlePage imageSource={TitleImg} dir={'row'} bgcolor={'rgb(3, 6, 54)'} highlightColor={'rgb(6, 12, 101)'} height={'400px'} Children={
                <>
                    <h1>Proman page</h1>
