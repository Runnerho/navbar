...
import TitleImg from '../assets/images/apartment.jpg';
import SupportedBy from "../components/supported";
import Footer from "../components/footer";

export default function IzRent(){
    return(
        <>
            <Header/>
            <TitlePage imageSource={TitleImg} dir={'row'} bgcolor={'rgb(3, 6, 54)'} highlightColor={'rgb(6, 12, 101)'} height={'250px'} Children={
                <>
                    <h1>Rent page</h1>
