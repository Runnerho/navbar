...
import TitleImg from '../assets/images/food.jpg';
import SupportedBy from "../components/supported";
import Footer from "../components/footer";

export default function IzFood(){
    return(
        <>
            <Header/>
            <TitlePage imageSource={TitleImg} dir={'row'} bgcolor={'rgb(3, 6, 54)'} highlightColor={'rgb(6, 12, 101)'} height={'350px'} Children={
                <>
                    <h1>Food page</h1>
