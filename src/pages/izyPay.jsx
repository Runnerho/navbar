...
import TitleImg from '../assets/images/pay.jpg';
import SupportedBy from "../components/supported";
import Footer from "../components/footer";

export default function IzPay(){
    return(
        <>
            <Header/>
            <TitlePage imageSource={TitleImg} dir={'row'} bgcolor={'rgb(3, 6, 54)'} highlightColor={'rgb(6, 12, 101)'} height={'300px'} Children={
                <>
                    <h1>Pay page</h1>
